...
<template>
  <div class="flex items-center gap-2" v-if="!loading">
    <div v-if="stateCounts[TransactionAuthStateOptions.Ausstehend] > 0" class="flex items-center gap-1"
    ...
    <div v-if="stateCounts[TransactionAuthStateOptions['In Bearbeitung']] > 0" class="flex items-center gap-1"
      title="Transaktionen in Bearbeitung">
    ...
    <div v-if="stateCounts[TransactionAuthStateOptions.Autorisiert] > 0" class="flex items-center gap-1"
      title="Autorisierte Transaktionen">
    ...
    <div v-if="stateCounts[TransactionAuthStateOptions.Abgeschlossen] > 0" class="flex items-center gap-1"
      title="Abgeschlossene Transaktionen">
    ...
    <div v-if="stateCounts[TransactionAuthStateOptions.Fehlgeschlagen] > 0" class="flex items-center gap-1"
      title="Fehlgeschlagene Transaktionen">
    ...
    <div v-if="stateCounts[TransactionAuthStateOptions.Abgelehnt] > 0" class="flex items-center gap-1"
      title="Abgelehnte Transaktionen">
